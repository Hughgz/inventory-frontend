        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname.includes("warehouse")}>
                {(handleClick, open) => (
                  <>
                    <a
                      href="#0"
                      className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname.includes("warehouse") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                      onClick={(e) => {
                        e.preventDefault();
                        handleClick();
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <svg
                            ...
                            viewBox="0 0 16 16"
                          >
                            <path d="M1 2h14v2H1zM3 6h10v2H3zM5 10h6v2H5z" />
                          </svg>
                          <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                            Quản lý kho gạo
                          </span>
                    ...
                    <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                      <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                        <li className="mb-1 last:mb-0">
                          <NavLink end to="/warehouse/import-receipt" className={({ isActive }) => linkClass(isActive)}>
                        ...
                        <li className="mb-1 last:mb-0">
                          <NavLink end to="/warehouse/export-receipt" className={({ isActive }) => linkClass(isActive)}>
                            <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 duration-200">
                              Xuất kho
                            </span>
                          </NavLink>
              ...
              {/* Danh mục */}
              <SidebarLinkGroup activecondition={pathname.includes("danh-muc")}>
                {(handleClick, open) => (
                  <>
                    <a href="#0" className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname.includes("danh-muc") ? "" : "hover:text-gray-900 dark:hover:text-white"}`}
                      onClick={(e) => { e.preventDefault(); handleClick(); setSidebarExpanded(true); }}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <svg className={`shrink-0 fill-current ${pathname.includes("danh-muc") ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16"><circle cx="8" cy="8" r="7" stroke="currentColor" strokeWidth="2" fill="none" /></svg>
                          <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 duration-200">Danh mục</span>
                        </div>
                        <svg className={`w-3 h-3 fill-current text-gray-400 ${open && "rotate-180"}`} viewBox="0 0 12 12"><path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" /></svg>
                      </div>
                    </a>
                    <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                      <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
              ...
              <SidebarLinkGroup activecondition={pathname === "/enterprise"}>
                {(handleClick, open) => (
                  <>
                    <NavLink
                      end
                    ...
                    >
                      <div className="flex items-center">
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d="M3 2v20h18V2H3zm16 2v3H5V4h14zM5 20v-9h14v9H5zM9 11h2v2H9v-2zm0 4h2v2H9v-2zm4-4h2v2h-2v-2zm0 4h2v2h-2v-2z" />
                        </svg>
